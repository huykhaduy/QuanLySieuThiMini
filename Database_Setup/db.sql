...
create table MAKHUYENMAI(
    SOKM int not null primary key auto_increment,
...
create table CHITIETKM_NCC(
    SOKM int not null,
    MANCC int not null,
    PRIMARY KEY (SOKM, MANCC)
);

create table CHITIETKM_SP(
    SOKM int not null,
    MASP INT not null,
    PRIMARY KEY (SOKM, MASP)
);
...
ALTER TABLE CHITIETKM_NCC ADD CONSTRAINT FK_CHITIETKM_NCC_SOKM FOREIGN KEY (SOKM) REFERENCES MAKHUYENMAI(SOKM);
...
ALTER TABLE CHITIETKM_SP ADD CONSTRAINT FK_CHITIETKM_SP_SOKM FOREIGN KEY (SOKM) REFERENCES MAKHUYENMAI(SOKM);
...
ALTER TABLE hoadon ADD CONSTRAINT FK_HOADON_KM FOREIGN KEY (SOKM) REFERENCES makhuyenmai(SOKM);
